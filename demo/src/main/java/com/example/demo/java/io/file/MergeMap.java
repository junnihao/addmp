...
public class MergeMap {
    ...
    public static List<HashMap<String, Object>> merge(List<HashMap<String, Object>> sourceList, List<HashMap<String, Object>> mergeObjectList,Map emptyMap, String key) {
        ...
        Optional.of(sourceList).orElse(new ArrayList<HashMap<String, Object>>()).parallelStream().forEach(o1 ->
        {
            Optional.of(mergeObjectList).orElse(new ArrayList<HashMap<String, Object>>()).parallelStream().forEach(o2 -> {
