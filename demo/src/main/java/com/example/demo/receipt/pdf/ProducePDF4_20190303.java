...
public class ProducePDF4_20190303 {
     ...
     * @param file
     */
    public ProducePDF4_20190303(File file) {
    ...
    public void generatePDF() throws Exception {
        ...
        document.add(createParagraph("苦参                        10g                     0.15                        1.50", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("瓜蒌皮                    10g                     0.08                        0.80", headFont, Element.ALIGN_LEFT));

        document.add(createParagraph("-  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -", keyFont, Element.ALIGN_CENTER));
        document.add(createParagraph("金额合计: 77.28", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("实收: 100.00", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("找零: 22.72", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("-  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -", keyFont, Element.ALIGN_CENTER));
        document.add(createParagraph("打印时间: 2015  03  03  19 : 51 : 25", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("谢谢惠顾,祝您早日康复", tailFont, Element.ALIGN_CENTER));
        document.close();
    }

    public static void main(String[] args) throws Exception {
        File file = new File("d:/INVOICE/刘修翔_20150303.pdf");
        file.createNewFile();
        new ProducePDF4_20190303(file).generatePDF();
