...
public class ProducePDF3_20180408 {
     ...
     * @param file
     */
    public ProducePDF3_20180408(File file) {
    ...
    public void generatePDF() throws Exception {
        ...
        document.add(createParagraph("-  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -", keyFont, Element.ALIGN_CENTER));
        document.add(createParagraph("金额合计: 51.00", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("实收: 60.00", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("找零: 9.00", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("-  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -", keyFont, Element.ALIGN_CENTER));
        document.add(createParagraph("打印时间: 2014  04  08  11 : 01 : 31", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("谢谢惠顾,祝您早日康复", tailFont, Element.ALIGN_CENTER));
        document.close();
    }

    public static void main(String[] args) throws Exception {
        File file = new File("d:/INVOICE/姚兰_20140408.pdf");
        file.createNewFile();
        new ProducePDF3_20180408(file).generatePDF();
