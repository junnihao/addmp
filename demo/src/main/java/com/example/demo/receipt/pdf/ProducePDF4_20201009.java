...
public class ProducePDF4_20201009 {
     ...
     * @param file
     */
    public ProducePDF4_20201009(File file) {
    ...
    public void generatePDF() throws Exception {
        ...
        document.add(createParagraph("-  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -", keyFont, Element.ALIGN_CENTER));
        document.add(createParagraph("金额合计: 125.00", headFont, Element.ALIGN_LEFT));
        ...
        document.add(createParagraph("-  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -", keyFont, Element.ALIGN_CENTER));
        document.add(createParagraph("打印时间: 2016  10  09  17 : 11 : 22", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("谢谢惠顾,祝您早日康复", tailFont, Element.ALIGN_CENTER));
        document.close();
    }

    public static void main(String[] args) throws Exception {
        File file = new File("d:/INVOICE/马鹏_20161009.pdf");
        file.createNewFile();
        new ProducePDF4_20201009(file).generatePDF();
