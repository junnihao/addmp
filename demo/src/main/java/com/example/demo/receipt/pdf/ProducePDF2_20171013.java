...
public class ProducePDF2_20171013 {
     ...
     * @param file
     */
    public ProducePDF2_20171013(File file) {
    ...
    public void generatePDF() throws Exception {
        ...
        document.add(createParagraph("-  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -", keyFont, Element.ALIGN_CENTER));
        document.add(createParagraph("打印时间: 2013  10  13  18 : 01 : 32", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("谢谢惠顾,祝您早日康复", tailFont, Element.ALIGN_CENTER));
        document.close();
    }

    public static void main(String[] args) throws Exception {
        File file = new File("d:/INVOICE/何炳英_20131013.pdf");
        file.createNewFile();
        new ProducePDF2_20171013(file).generatePDF();
