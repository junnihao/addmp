...
public class ProducePDF6_20160303 {
     ...
     * @param file
     */
    public ProducePDF6_20160303(File file) {
    ...
    public void generatePDF() throws Exception {
        ...
        document.add(createParagraph("金银花                    15g                     0.60                        9.00", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("连翘                        9g                     0.30                        2.70", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("竹叶                        9g                     0.06                        0.54", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("荆芥                        10g                     0.08                        0.80", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("牛蒡子                    10g                     0.10                        1.00", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("淡豆豉                    10g                     0.10                        1.00", headFont, Element.ALIGN_LEFT));
        ...
        document.add(createParagraph("芦根                        10g                     0.08                        0.80", headFont, Element.ALIGN_LEFT));
        ...
        document.add(createParagraph("-  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -", keyFont, Element.ALIGN_CENTER));
        document.add(createParagraph("金额合计: 122.20", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("实收: 150.00", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("找零: 27.80", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("-  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -", keyFont, Element.ALIGN_CENTER));
        document.add(createParagraph("打印时间: 2016  03  30  15 : 11 : 12", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("谢谢惠顾,祝您早日康复", tailFont, Element.ALIGN_CENTER));
        document.close();
    }

    public static void main(String[] args) throws Exception {
        File file = new File("d:/INVOICE/other5/陈阿池_20160330.pdf");
        file.createNewFile();
        new ProducePDF6_20160303(file).generatePDF();
