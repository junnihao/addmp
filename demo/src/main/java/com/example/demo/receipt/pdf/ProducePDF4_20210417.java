...
public class ProducePDF4_20210417 {
     ...
     * @param file
     */
    public ProducePDF4_20210417(File file) {
    ...
    public void generatePDF() throws Exception {
        ...
        document.add(createParagraph("肉桂                        15g                     0.10                        0.15", headFont, Element.ALIGN_LEFT));

        document.add(createParagraph("-  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -", keyFont, Element.ALIGN_CENTER));
        document.add(createParagraph("金额合计: 47.10", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("实收: 50.00", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("找零: 2.90", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("-  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -", keyFont, Element.ALIGN_CENTER));
        document.add(createParagraph("打印时间: 2017  04  17  20 : 28 : 51", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("谢谢惠顾,祝您早日康复", tailFont, Element.ALIGN_CENTER));
        document.close();
    }

    public static void main(String[] args) throws Exception {
        File file = new File("d:/INVOICE/other5/张晓娜_20170417.pdf");
        file.createNewFile();
        new ProducePDF4_20210417(file).generatePDF();
