...
public class ProducePDF4_20210411 {
     ...
     * @param file
     */
    public ProducePDF4_20210411(File file) {
    ...
    public void generatePDF() throws Exception {
        ...
        document.add(createParagraph("干姜                        5g                     0.15                        1.05", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("细辛                        15g                     0.40                        2.00", headFont, Element.ALIGN_LEFT));
        ...
        document.add(createParagraph("-  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -", keyFont, Element.ALIGN_CENTER));
        document.add(createParagraph("金额合计: 107.50", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("实收: 120.00", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("找零: 12.50", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("-  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -", keyFont, Element.ALIGN_CENTER));
        document.add(createParagraph("打印时间: 2017  04  11  12 : 18 : 11", headFont, Element.ALIGN_LEFT));
        document.add(createParagraph("谢谢惠顾,祝您早日康复", tailFont, Element.ALIGN_CENTER));
        document.close();
    }

    public static void main(String[] args) throws Exception {
        File file = new File("d:/INVOICE/张晓娜_20170411.pdf");
        file.createNewFile();
        new ProducePDF4_20210411(file).generatePDF();
